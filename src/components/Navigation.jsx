                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                <a href="#demo" className="text-black px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Home</a>
                                <a href="#demo" className="text-gray-400 hover:text-black px-3 py-2 rounded-md text-sm font-medium">Team</a>
                                <a href="#demo" className="text-gray-400 hover:text-black px-3 py-2 rounded-md text-sm font-medium">Projects</a>
                                <a href="#demo" className="text-gray-400 hover:text-black px-3 py-2 rounded-md text-sm font-medium">Calendar</a>
                                <a href="#demo" className="text-gray-400 hover:text-black px-3 py-2 rounded-md text-sm font-medium">Reports</a>
                            </div>
                        </div>
                    </div>
